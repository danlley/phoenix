 ...
 * 
 * @author min.weixm
 * @version $Id: PxSubPackagesDO.java, v 0.1 Jul 28, 2018 9:25:06 AM min.weixm Exp $
 */
public class PxSubPackagesDO implements Serializable {

    /** serialVersionUID */
    private static final long serialVersionUID = 7805466563560330144L;
    ...
    /** 套餐类型，如：大份、小份等 */
    private String            subPackagesType;
     ...
     */
    public String getSubPackagesType() {
     ...
     */
    public void setSubPackagesType(String subPackagesType) {
