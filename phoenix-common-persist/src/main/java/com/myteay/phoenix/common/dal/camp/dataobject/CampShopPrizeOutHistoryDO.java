 ...
 * 
 * @author danlley
 * @version $Id: CampShopPrizeOutHistoryDO.java, v 0.1 Mar 27, 2019 10:13:21 PM danlley Exp $
 */
public class CampShopPrizeOutHistoryDO implements Serializable {

    /** serialVersionUID */
    private static final long serialVersionUID = -6349643578872010853L;
     ...
     */
    public String getPrizeOutStatus() {
     ...
     */
    public void setPrizeOutStatus(String prizeOutStatus) {
