...
public class PxGoodsPackagesNoticeController {
    ...
    /** 日志 */
    public static final Logger             logger = Logger.getLogger(PxGoodsPackagesNoticeController.class);
    ...
    public MtServiceResult<List<PxGoodsPackagesNoticeModel>> queryGoodsByShopId(@PathVariable String goodsId) {
        ...
        try {
            componentResult = pxCommonManageComponent.queryPackagesNoticeListByGoodsId(goodsId);
    ...
    public MtServiceResult<PxGoodsPackagesNoticeModel> manageGoods(@RequestBody PxGoodsPackagesNoticeModel pxGoodsPackagesNoticeModel) {
        ...
        try {
            MtOperateResult<PxGoodsPackagesNoticeModel> innerResult = pxGoodsPackagesNoticeComponent.manageGoodsPackagesNotice(pxGoodsPackagesNoticeModel);
