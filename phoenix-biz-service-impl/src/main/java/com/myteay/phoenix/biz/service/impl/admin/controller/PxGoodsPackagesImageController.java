...
public class PxGoodsPackagesImageController {
    ...
    public MtServiceResult<List<PxGoodsPackagesImageModel>> queryGoodsByShopId(@PathVariable String goodsId) {
    ...
    public MtServiceResult<PxGoodsPackagesImageModel> manageGoods(@RequestBody PxGoodsPackagesImageModel pxGoodsPackagesImageModel) {

        if (logger.isInfoEnabled()) {
            logger.info("开始保存套餐详情图片信息 pxGoodsPackagesImageModel=" + pxGoodsPackagesImageModel);
        }
