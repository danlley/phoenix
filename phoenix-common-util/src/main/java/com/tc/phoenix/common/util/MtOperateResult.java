 ...
 * 
 * @author min.weixm
 * @version $Id: MtOperateResult.java, v 0.1 Feb 10, 2020 10:08:04 PM min.weixm Exp $
 */
public class MtOperateResult<T> implements Serializable {
     ...
     * @param result
     */
    public MtOperateResult(MtOperateResultEnum operateResult, MtOperateExResultEnum operateExResult, T result) {
        this.errorDetail = operateExResult.getMessage();
        this.errorCode = operateExResult.getCode();
        this.operateResult = operateResult;
        this.operateExResult = operateExResult;
