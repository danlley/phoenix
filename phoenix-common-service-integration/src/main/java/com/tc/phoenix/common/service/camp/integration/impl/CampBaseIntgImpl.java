 ...
 */
package com.tc.phoenix.common.service.camp.integration.impl;
...
import com.tc.phoenix.common.service.camp.integration.CampBaseIntg;
...
public class CampBaseIntgImpl implements CampBaseIntg {
    ...
    /** 
     * @see com.tc.phoenix.common.service.camp.integration.CampBaseIntg#queryAllCampBaseByShopId(java.lang.String)
     */
    @Override
    ...
    /** 
     * @see com.tc.phoenix.common.service.camp.integration.CampBaseIntg#manageCampBase(com.myteay.phoenix.core.model.camp.CampBaseModel)
     */
    @Override
    ...
    /** 
     * @see com.tc.phoenix.common.service.camp.integration.CampBaseIntg#changeCampBaseStatus(com.myteay.phoenix.core.model.camp.CampBaseModel)
     */
    @Override
